    ...
    const fetchDashboardData = async () => {
      ...
      try {
        const response = await axios.get(
          "https://mocki.io/v1/6fabb29a-df50-4849-b8f4-6b3d5397b4a8"
        );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div
          className="bg-white rounded-lg shadow-md p-5 hover:shadow-xl transition-shadow duration-300 border-l-4 border-blue-500 cursor-pointer"
        ...
        <div
          className="bg-white rounded-lg shadow-md p-5 hover:shadow-xl transition-shadow duration-300 border-l-4 border-green-500 cursor-pointer"
          onClick={() => navigate('/opd-patients')}
        >
          <div className="flex justify-between">
            <div>
              <p className="text-gray-500 font-medium">OPD Patients</p>
              <h3 className="text-3xl font-bold text-[#0e1630] mt-2">
          ...
          {/* IPD Patients */}
        <div
          className="bg-white rounded-lg shadow-md p-5 hover:shadow-xl transition-shadow duration-300 border-l-4 border-amber-500 cursor-pointer"
          onClick={() => navigate('/ipd-patients')}
        >
          <div className="flex justify-between">
            <div>
              <p className="text-gray-500 font-medium">IPD Patients</p>
              <h3 className="text-3xl font-bold text-[#0e1630] mt-2">
          ...
          {/* Virtual Patients */}
          <div
          className="bg-white rounded-lg shadow-md p-5 hover:shadow-xl transition-shadow duration-300 border-l-4 border-purple-500 cursor-pointer"
          onClick={() => navigate('/virtual-patients')}
        >
          <div className="flex justify-between">
            <div>
