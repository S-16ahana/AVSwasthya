        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          ...
          <form className="space-y-4 text-sm">
            ...
            <div className="flex gap-2 mb-4">
              <select className="p-2 w-1/2 border rounded-md" value={state} onChange={e => setState(e.target.value)} aria-label="Select State">
              ...
              <select className="p-2 w-1/2 border rounded-md" value={city} onChange={e => setCity(e.target.value)} aria-label="Select City">
